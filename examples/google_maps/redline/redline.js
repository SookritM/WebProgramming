...
var stations = [
	...
	{"station_name":"Park Street", "latitude":42.31129, "longitude":-71.053331},
...
function init() {
	...
	for (var count = 0; count < stations.length; count++) {
		marker = new google.maps.Marker({
			position: new google.maps.LatLng(stations[count].latitude,stations[count].longitude),
		...
		google.maps.event.addListener(marker, 'click', function() {
			...
			request.open("GET", "https://protected-garden-71486.herokuapp.com/redline.json", true);
