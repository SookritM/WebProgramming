...
#Thursday, December 1st: Semester Group Project
...
#Tuesday, December 6th and Thursday December 8th: What's The Point (of this course)?
* Course evaluations
* You've barely scratched the surface
  - What reality is really like
  - What engineering issues do you see here?
  - Want to learn and build something over the break?  Mobile app that renders a map of the MBTA stations from your Lab 7.
* The big ideas from this class:
  ...
  - Communications
* Reads:
  - http://tuftsdaily.com/news/2016/10/19/changes-ta-system-accompany-growth-computer-science-department/
  - http://www.cs.tufts.edu/comp/105/notes.html#toc16
  - "Traps and pitfalls for friendly teachers" http://www.cs.tufts.edu/comp/50/handouts/teachers-guide.html
* Quiz
